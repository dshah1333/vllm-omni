...
def test_dlo_host_weight_cache_is_built_after_final_post_load_mutation(monkeypatch, tmp_path):
    import vllm_omni.diffusion.model_loader.diffusers_loader as loader_mod
    import vllm_omni.diffusion.model_loader.host_weight_cache as cache_mod
...
def test_dlo_host_weight_cache_failure_retains_ordinary_weights(monkeypatch, tmp_path):
    import vllm_omni.diffusion.model_loader.diffusers_loader as loader_mod
    import vllm_omni.diffusion.model_loader.host_weight_cache as cache_mod
